...
ALTER TABLE instance_pages ADD COLUMN source TEXT NOT NULL DEFAULT 'studio';
ALTER TABLE instance_pages ADD COLUMN market_id TEXT NOT NULL DEFAULT '';
ALTER TABLE instance_pages ADD COLUMN market_version TEXT NOT NULL DEFAULT '';
