...
ALTER TABLE stacks ADD COLUMN remote_address VARCHAR(255) NOT NULL DEFAULT '';
ALTER TABLE stacks ADD COLUMN remote_use_tls INTEGER NOT NULL DEFAULT 0;
ALTER TABLE stacks ADD COLUMN remote_skip_verify INTEGER NOT NULL DEFAULT 0;
ALTER TABLE stacks ADD COLUMN token_hash VARCHAR(128) NOT NULL DEFAULT '';
ALTER TABLE stacks ADD COLUMN token_prefix VARCHAR(16) NOT NULL DEFAULT '';
ALTER TABLE stacks ADD COLUMN token_plain TEXT NOT NULL DEFAULT '';
ALTER TABLE stacks ADD COLUMN status VARCHAR(16) NOT NULL DEFAULT 'down';
ALTER TABLE stacks ADD COLUMN last_seen_at TEXT;

CREATE INDEX idx_stacks_status ON stacks(status);
CREATE INDEX idx_stacks_token_hash ON stacks(token_hash);
