...
CREATE INDEX instance_automation_inst_idx ON instance_automation(instance_id);
CREATE INDEX instance_automation_due_idx ON instance_automation(enabled, next_run_at);
...
CREATE INDEX automation_runs_inst_idx ON automation_runs(instance_id, started_at DESC);
