...
ALTER TABLE stacks ADD COLUMN proxy_port INTEGER NOT NULL DEFAULT 0;
ALTER TABLE stacks ADD COLUMN proxy_root_url VARCHAR(64) NOT NULL DEFAULT '';

CREATE INDEX idx_stacks_proxy_root ON stacks(proxy_root_url);
