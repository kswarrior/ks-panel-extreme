...
CREATE INDEX idx_ticket_attachments_sha ON ticket_attachments(sha256);
...
INSERT IGNORE INTO settings (key, value) VALUES ('ticket_sla_config', '{"general":{"first_response_mins":60,"resolve_hours":24},"billing":{"first_response_mins":120,"resolve_hours":48},"technical":{"first_response_mins":30,"resolve_hours":12},"feature":{"first_response_mins":240,"resolve_hours":168},"bug":{"first_response_mins":60,"resolve_hours":24},"abuse":{"first_response_mins":30,"resolve_hours":8},"other":{"first_response_mins":120,"resolve_hours":48}}');
INSERT IGNORE INTO settings (key, value) VALUES ('smtp_tls', 'auto');
