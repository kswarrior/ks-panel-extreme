...
CREATE INDEX mods_owner_idx            ON mods(owner_id);
CREATE INDEX applications_owner_idx    ON applications(owner_id);
CREATE INDEX instance_pages_owner_idx  ON instance_pages(owner_id);
CREATE INDEX themes_owner_idx          ON themes(owner_id);
CREATE INDEX roles_owner_idx           ON roles(owner_id);
