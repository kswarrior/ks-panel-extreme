...
CREATE INDEX IF NOT EXISTS idx_backup_schedules_inst ON backup_schedules(instance_id);
...
CREATE INDEX IF NOT EXISTS idx_instance_file_backups_inst ON instance_file_backups(instance_id, created_at DESC);
