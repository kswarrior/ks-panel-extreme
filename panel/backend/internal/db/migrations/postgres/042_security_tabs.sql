...
INSERT INTO settings (key, value) VALUES ('security_ip_allowlist', '') ON CONFLICT DO NOTHING;
INSERT INTO settings (key, value) VALUES ('security_ip_denylist', '') ON CONFLICT DO NOTHING;
INSERT INTO settings (key, value) VALUES ('security_max_body_size_mb', '10') ON CONFLICT DO NOTHING;
INSERT INTO settings (key, value) VALUES ('security_allowed_http_methods', '') ON CONFLICT DO NOTHING;
INSERT INTO settings (key, value) VALUES ('security_block_suspicious_paths', '0') ON CONFLICT DO NOTHING;
INSERT INTO settings (key, value) VALUES ('security_session_lifetime_minutes', '480') ON CONFLICT DO NOTHING;
INSERT INTO settings (key, value) VALUES ('security_session_idle_timeout_minutes', '1440') ON CONFLICT DO NOTHING;
INSERT INTO settings (key, value) VALUES ('security_session_max_per_user', '0') ON CONFLICT DO NOTHING;
