...
ALTER TABLE nodes ADD COLUMN IF NOT EXISTS driver_docker INTEGER NOT NULL DEFAULT 0;
ALTER TABLE nodes ADD COLUMN IF NOT EXISTS driver_kvm INTEGER NOT NULL DEFAULT 0;
ALTER TABLE nodes ADD COLUMN IF NOT EXISTS driver_multipass INTEGER NOT NULL DEFAULT 0;
ALTER TABLE nodes ADD COLUMN IF NOT EXISTS driver_lxd INTEGER NOT NULL DEFAULT 0;
