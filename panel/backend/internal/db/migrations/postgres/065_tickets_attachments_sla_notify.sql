...
INSERT INTO settings (key, value) VALUES ('ticket_sla_config', '{"general":{"first_response_mins":60,"resolve_hours":24},"billing":{"first_response_mins":120,"resolve_hours":48},"technical":{"first_response_mins":30,"resolve_hours":12},"feature":{"first_response_mins":240,"resolve_hours":168},"bug":{"first_response_mins":60,"resolve_hours":24},"abuse":{"first_response_mins":30,"resolve_hours":8},"other":{"first_response_mins":120,"resolve_hours":48}}') ON CONFLICT DO NOTHING;
INSERT INTO settings (key, value) VALUES ('smtp_tls', 'auto') ON CONFLICT DO NOTHING;
