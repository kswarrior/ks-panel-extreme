...
ALTER TABLE stacks ADD COLUMN IF NOT EXISTS serve_port INTEGER NOT NULL DEFAULT 0;
ALTER TABLE stacks ADD COLUMN IF NOT EXISTS serve_auth INTEGER NOT NULL DEFAULT 1;
ALTER TABLE stacks ADD COLUMN IF NOT EXISTS serve_theme INTEGER NOT NULL DEFAULT 1;

CREATE INDEX IF NOT EXISTS idx_stacks_serve_port ON stacks(serve_port);
