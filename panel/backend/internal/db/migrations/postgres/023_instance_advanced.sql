...
CREATE INDEX IF NOT EXISTS instance_snapshots_inst_idx ON instance_snapshots(instance_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS instance_audit_inst_idx ON instance_audit(instance_id, created_at DESC);
