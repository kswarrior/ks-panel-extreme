...
ALTER TABLE nodes ADD COLUMN IF NOT EXISTS alloc_mem_mib INTEGER NOT NULL DEFAULT 0;
ALTER TABLE nodes ADD COLUMN IF NOT EXISTS mem_overcommit_pct INTEGER NOT NULL DEFAULT 0;
ALTER TABLE nodes ADD COLUMN IF NOT EXISTS alloc_disk_mib INTEGER NOT NULL DEFAULT 0;
ALTER TABLE nodes ADD COLUMN IF NOT EXISTS disk_overcommit_pct INTEGER NOT NULL DEFAULT 0;
ALTER TABLE nodes ADD COLUMN IF NOT EXISTS instances_dir TEXT NOT NULL DEFAULT '';
