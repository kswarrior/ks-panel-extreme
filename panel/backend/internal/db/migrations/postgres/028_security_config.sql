...
INSERT INTO settings (key, value) VALUES ('security_requests_per_minute_limit', '600') ON CONFLICT DO NOTHING;
INSERT INTO settings (key, value) VALUES ('security_window_seconds_limit', '60') ON CONFLICT DO NOTHING;
INSERT INTO settings (key, value) VALUES ('security_global_rpm_limit', '0') ON CONFLICT DO NOTHING;
