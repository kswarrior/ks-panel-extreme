...
ALTER TABLE nodes ADD COLUMN IF NOT EXISTS hw_ram_ok     INTEGER NOT NULL DEFAULT 0;
ALTER TABLE nodes ADD COLUMN IF NOT EXISTS hw_cpu_ok     INTEGER NOT NULL DEFAULT 0;
ALTER TABLE nodes ADD COLUMN IF NOT EXISTS hw_disk_ok    INTEGER NOT NULL DEFAULT 0;
ALTER TABLE nodes ADD COLUMN IF NOT EXISTS hw_uptime_ok  INTEGER NOT NULL DEFAULT 0;
ALTER TABLE nodes ADD COLUMN IF NOT EXISTS hw_drivers_ok INTEGER NOT NULL DEFAULT 0;
...
ALTER TABLE nodes ADD COLUMN IF NOT EXISTS probe_reachable INTEGER;
...
ALTER TABLE nodes ADD COLUMN IF NOT EXISTS probe_seen_name TEXT;
-- UTC timestamp of the last probe attempt (success or failure).
ALTER TABLE nodes ADD COLUMN IF NOT EXISTS probe_checked_at TIMESTAMP;
