...
CREATE INDEX IF NOT EXISTS security_requests_created_idx ON security_requests(created_at);
CREATE INDEX IF NOT EXISTS security_requests_ip_idx     ON security_requests(client_ip);
CREATE INDEX IF NOT EXISTS security_requests_status_idx ON security_requests(status);
CREATE INDEX IF NOT EXISTS security_requests_login_idx ON security_requests(is_login, status);
...
INSERT INTO settings (key, value) VALUES ('security_under_attack', '0') ON CONFLICT DO NOTHING;
INSERT INTO settings (key, value) VALUES ('security_block_unknown_ua', '0') ON CONFLICT DO NOTHING;
