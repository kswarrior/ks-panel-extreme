...
ALTER TABLE instance_pages ADD COLUMN IF NOT EXISTS source_tsx TEXT;
ALTER TABLE instance_pages ADD COLUMN IF NOT EXISTS bundle_js TEXT;
ALTER TABLE instance_pages ADD COLUMN IF NOT EXISTS bundle_css TEXT;
ALTER TABLE instance_pages ADD COLUMN IF NOT EXISTS build_status VARCHAR(16) NOT NULL DEFAULT '';
ALTER TABLE instance_pages ADD COLUMN IF NOT EXISTS build_log TEXT;
