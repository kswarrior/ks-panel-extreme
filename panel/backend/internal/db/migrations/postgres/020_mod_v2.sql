...
ALTER TABLE mods ADD COLUMN IF NOT EXISTS engine_version INTEGER NOT NULL DEFAULT 1;
...
CREATE INDEX IF NOT EXISTS mod_storage_mod_idx ON mod_storage(mod_slug);
