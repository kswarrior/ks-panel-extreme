...
CREATE INDEX IF NOT EXISTS mods_active_idx ON mods(active);
CREATE INDEX IF NOT EXISTS mods_uploaded_by_idx ON mods(uploaded_by);
...
CREATE INDEX IF NOT EXISTS mod_permissions_mod_idx ON mod_permissions(mod_id);
