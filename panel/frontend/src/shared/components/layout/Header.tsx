...
export function resolveHeaderCrumb(rawPath: string): HeaderCrumb | null {
  ...
  const rules: Array<[RegExp, HeaderCrumb]> = [
    ...
    [/^\/instances\/schedules$/, { parent: 'Instances', parentTo: '/instances', current: 'Schedules', icon: 'Instances' }],
    [/^\/instances\/new$/, { parent: 'Instances', parentTo: '/instances', current: 'New Instance', icon: 'Instances' }],
    [/^\/instances\/new\/advanced$/, { parent: 'Instances', parentTo: '/instances', current: 'Advance Option', icon: 'Instances' }],
    ...
    [/^\/notifications\/schedules$/, { parent: 'Notifications', parentTo: '/notifications', current: 'Schedules', icon: 'Notifications' }],
    [/^\/notifications\/broadcast$/, { parent: 'Notifications', parentTo: '/notifications', current: 'Broadcast', icon: 'Notifications' }],
    [/^\/notification\/[^/]+$/, { parent: 'Notifications', parentTo: '/notifications', current: 'Detail', icon: 'Notifications' }],
    ...
    [/^\/themes\/schedules$/, { parent: 'Themes', parentTo: '/themes', current: 'Schedules', icon: 'Themes' }],
    [/^\/theme\/[^/]+$/, { parent: 'Themes', parentTo: '/themes', current: 'Detail', icon: 'Themes' }],
    ...
    [/^\/tickets\/schedules$/, { parent: 'Tickets', parentTo: '/tickets', current: 'Schedules', icon: 'Tickets' }],
    ...
    [/^\/users\/schedules$/, { parent: 'Users', parentTo: '/users', current: 'Schedules', icon: 'Users' }],
    ...
    [/^\/roles\/schedules$/, { parent: 'Roles', parentTo: '/roles', current: 'Schedules', icon: 'Roles' }],
    ...
    [/^\/role\/[^/]+$/, { parent: 'Roles', parentTo: '/roles', current: 'Detail', icon: 'Roles' }],
    ...
    [/^\/api-keys\/schedules$/, { parent: 'API Keys', parentTo: '/api-keys', current: 'Schedules', icon: 'ApiKeys' }],
    ...
    [/^\/templates\/schedules$/, { parent: 'Templates', parentTo: '/templates', current: 'Schedules', icon: 'Templates' }],
    ...
    [/^\/mods\/schedules$/, { parent: 'Mods', parentTo: '/mods', current: 'Schedules', icon: 'Mods' }],
    [/^\/mod\/[^/]+$/, { parent: 'Mods', parentTo: '/mods', current: 'Detail', icon: 'Mods' }],
    [/^\/applications$/, { parent: 'Applications', parentTo: '/applications', icon: 'Applications' }],
    [/^\/applications\/studio$/, { parent: 'Applications', parentTo: '/applications', current: 'Studio', icon: 'Applications' }],
    [/^\/applications\/stats$/, { parent: 'Applications', parentTo: '/applications', current: 'Statistics', icon: 'Applications' }],
    [/^\/applications\/schedules$/, { parent: 'Applications', parentTo: '/applications', current: 'Schedules', icon: 'Applications' }],
    [/^\/applications\/new$/, { parent: 'Applications', parentTo: '/applications', current: 'New Application', icon: 'Applications' }],
    [/^\/application\/[^/]+$/, { parent: 'Applications', parentTo: '/applications', current: 'Detail', icon: 'Applications' }],
    ...
    [/^\/instance-pages\/schedules$/, { parent: 'Pages', parentTo: '/instance-pages', current: 'Schedules', icon: 'Templates' }],
          ...
          <nav aria-label="Breadcrumb" className="flex items-center min-w-0 text-xs text-gray-400">
            {hasTabs ? (
              <button
                ...
                className="group flex items-center gap-1.5 min-w-0 bg-transparent hover:bg-transparent px-1 py-1 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-500 rounded-md"
