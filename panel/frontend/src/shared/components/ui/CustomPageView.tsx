...
function customPageThemeCss(theme: Theme, pageSlugOrPath?: string): string {
  ...
  let baseCss = `
    ...
    .ks-actions-pill .ks-pill-toggle:hover, .ks-actions-pill .ks-pill-toggle:active, .ks-actions-pill .ks-pill-toggle:focus, .ks-actions-pill .ks-pill-toggle:focus-visible, .ks-form-actions-pill .ks-pill-toggle:hover, .ks-form-actions-pill .ks-pill-toggle:active, .ks-form-actions-pill .ks-pill-toggle:focus, .ks-form-actions-pill .ks-pill-toggle:focus-visible { background: var(--ks-tab-inactive-bg, transparent) !important; color: var(--ks-pill-text, #e5e7eb) !important; }
    .ks-card.ks-pill-anim.ks-actions-pill, .ks-card.ks-pill-anim.ks-form-actions-pill { transition-property: transform, opacity, padding-left, padding-right !important; }
    .ks-actions-pill .ks-pill-toggle, .ks-form-actions-pill .ks-pill-toggle { transition-property: background-color, color, padding-left, padding-right !important; transition-duration: 300ms !important; }
