...
export const InstanceProcesses: React.FC = () => {
  ...
  if (!instance) return <LoadingOrError loading={false} error="Instance not found" kind="processes" />;
  if (tplLoading) return <LoadingOrError loading={true} error="" kind="processes" />;
