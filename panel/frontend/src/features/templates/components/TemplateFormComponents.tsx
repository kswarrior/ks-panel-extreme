...
export const TemplateTabs = <T extends string>({ tab, onChange, tabs }: { tab: T; onChange: (id: T) => void; tabs?: Array<{ id: string; label: string }> }) => {
  const meta = {
    ...
    config: { label: 'Config Files', hint: 'Parsers: properties/yaml/json/ini/xml/file/toml', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M9 13h6"/><path d="M9 17h6"/></svg> },
