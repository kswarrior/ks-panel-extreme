    ...
    <div className="space-y-4">
      ...
      <div className={sectionCls}>
        ...
        <p className="text-[11px] text-gray-500 mt-1">
          More opens <code className="font-mono text-sky-300">/{(c.more_page.trim().replace(/^\/+|\/+$/g, '') || DEFAULT_INSTANCE_CONTROLS.more_page)}</code>. Use a page Path or a built-in (overview, ports, sftp, snapshots, files, terminal). Unknown slugs fall back to Overview.
        </p>
        {!moreKnown && (
