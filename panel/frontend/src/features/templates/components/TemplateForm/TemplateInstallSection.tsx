...
export interface InstallSectionProps {
  ...
  /** Attach-by-ID handle for the Installation console (spec.install_terminal_id). Empty = no console. */
  installTerminalId?: string;
  onInstallTerminalIdUpdate?: (v: string) => void;
  sectionCls: string;
  labelCls: string;
  monoCls: string;
  addBtn: string;
      ...
      <div className={sectionCls}>
        ...
        <div className="space-y-3">
          {install.map((s, i) => {
            ...
            return (
              <div key={i} className="ks-card ks-form-card ks-template-row-card ks-install-card rounded-md overflow-hidden">
