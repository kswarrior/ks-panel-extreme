  ...
  return (
    <div className="max-w-[1280px] mx-auto space-y-4">
      ...
      <div className="sm:hidden">
        <Link to={`/tickets/${ticket.id}`} className="ks-btn-ghost w-full inline-flex items-center justify-center gap-1.5 text-sm px-3 py-2 rounded-lg border" style={{ borderColor: 'var(--ks-card-border)', color: 'var(--ks-text-body)' }}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-4 h-4">
            <path d="M19 12H5" />
            <path d="M12 19l-7-7 7-7" />
          </svg>
