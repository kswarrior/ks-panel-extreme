  ...
  return (
    <GlassCard className="space-y-4">
      <div className="ks-form-card rounded-lg space-y-4">
        <Label label="Surface" hint="The pill's glass background. Defaults follow the live Card tab until overridden." />
      ...
      <div className="ks-form-card rounded-lg space-y-4">
        <Label label="Buttons" hint="Size of the action buttons living inside the pill." />
      ...
      <div className="ks-form-card rounded-lg space-y-4">
        <Label label="Collapse animation" hint="Motion played when the pill goes off / on. The pill never disappears — off just shows `<`." />
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Select
            label="Animation"
            value={p.animation}
      ...
      <div className="ks-form-card rounded-lg space-y-4">
        <Label label="Auto-off timing" hint="Scroll or outside-click collapses the pill to `<`; idle slides it back on." />
        ...
        {!autoOn && (
          <p className="text-xs text-gray-500">Auto-off disabled — the pill stays open until the `&gt;` toggle is clicked.</p>
        )}
      </div>

      <div className="ks-form-card rounded-lg space-y-3">
        <Label label="Preview" hint="Live sample painted from this tab. Simulate collapses it, then auto-ons after your delay." />
