    ...
    >
      <div className="space-y-6">
        ...
        <GlassCard className="">
            ...
            <div className="flex flex-col items-center gap-1" title="Card preview">
              <span
              ...
              <span className="text-[11px] text-gray-500 max-w-[12rem] truncate">{(displayName.trim() || name.trim()) || 'Instance'}</span>
            </div>
            ...
            <div className="mt-4">
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  className="shrink-0 w-7 h-7 rounded-full border border-white/10 bg-white/5 text-gray-300 hover:bg-white/10 transition-colors"
                >
                  ‹
                </button>
