...
const METRICS_LIVE = page(
  ...
  `
    ...
    function drawChart(){
      ...
      // Canvas APIs need concrete colors — resolve theme tokens once per draw.
      ctx.strokeStyle = tok('--ks-card-border', 'rgba(255,255,255,0.08)');
      ctx.strokeRect(0.5, 0.5, cv.width - 1, cv.height - 1);
      if (cpuHist.length < 2) return;
      ctx.beginPath();
      ctx.strokeStyle = tok('--ks-info', '#38bdf8');
      ctx.lineWidth = 1.5;
  ...
  },
{
  ...
  },
  {
    ...
    slug: "files",
    category: "management",
    description: "File manager with upload, download, rename, delete, and a built-in editor",
  ...
  },
  {
    ...
    slug: "home",
    category: "overview",
    description: "Instance overview with status, resource metrics, and quick actions",
  ...
  },
  {
    ...
    slug: "ports",
    category: "networking",
    description: "Listening sockets reported by the edge inspect endpoint",
    iconSvg: "<rect x=\"4\" y=\"4\" width=\"16\" height=\"16\" rx=\"2\"/><path d=\"M9 4v16M15 4v16M4 9h16M4 15h16\"/>",
    html: LIB_PORTS_HTML,
  },
  {
    id: "lib-processes",
