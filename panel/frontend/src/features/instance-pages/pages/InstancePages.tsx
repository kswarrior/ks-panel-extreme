  ...
  return (
    <div>
      ...
      <PageActionsPill>
          ...
          <Link
            to="/instance-pages/schedules"
            aria-label="Instance page schedules"
            className="ks-tab inline-flex items-center justify-center"
            style={PILL_TAB_STYLE}
            title="Instance page schedules"
          >
          ...
          <button
            ...
            className="ks-tab inline-flex items-center justify-center disabled:opacity-50"
            style={PILL_TAB_STYLE}
