...
export const AREAS: AreaEntry[] = [
  ...
  },
  {
    id: 'admin',
    label: 'Admin Panel',
    description: 'System overview, security telemetry, activity, database, users, roles, API keys, nodes, templates, themes, instances, tickets, notifications, mods, applications.',
    prefix: '/',
    pages: [
      ...
      adminPage('admin.users.stats', 'Users · Stats', 'users/stats'),
      adminPage('admin.users.schedules', 'Users · Schedules', 'users/schedules'),
      adminPage('admin.user.detail', 'User · Detail', 'user/:id'),
      ...
      adminPage('admin.roles.stats', 'Roles · Stats', 'roles/stats'),
      adminPage('admin.roles.schedules', 'Roles · Schedules', 'roles/schedules'),
      adminPage('admin.role.detail', 'Role · Detail', 'role/:id'),
      ...
      adminPage('admin.api-keys.stats', 'API Keys · Stats', 'api-keys/stats'),
      adminPage('admin.api-keys.schedules', 'API Keys · Schedules', 'api-keys/schedules'),
      adminPage('admin.api-key.detail', 'API Key · Detail', 'api-key/:id'),
      ...
      adminPage('admin.nodes.stats', 'Nodes · Stats', 'nodes/stats'),
      adminPage('admin.nodes.schedules', 'Nodes · Schedules', 'nodes/schedules'),
      adminPage('admin.node.detail', 'Node · Detail', 'node/:id'),
      ...
      adminPage('admin.templates.stats', 'Templates · Stats', 'templates/stats'),
      adminPage('admin.templates.schedules', 'Templates · Schedules', 'templates/schedules'),
      adminPage('admin.template.detail', 'Template · Detail', 'template/:id'),
      adminPage('admin.mods', 'Mods', 'mods'),
      adminPage('admin.mods.studio', 'Mod Studio', 'mods/studio'),
      adminPage('admin.mods.stats', 'Mods · Stats', 'mods/stats'),
      ...
      adminPage('admin.applications.stats', 'Applications · Stats', 'applications/stats'),
      adminPage('admin.applications.schedules', 'Applications · Schedules', 'applications/schedules'),
      adminPage('admin.application.detail', 'Application · Detail', 'application/:id'),
      adminPage('admin.themes', 'Themes', 'themes'),
      adminPage('admin.themes.studio', 'Theme Studio', 'themes/studio'),
      adminPage('admin.themes.stats', 'Themes · Stats', 'themes/stats'),
      adminPage('admin.themes.schedules', 'Themes · Schedules', 'themes/schedules'),
      adminPage('admin.theme.detail', 'Theme · Detail', 'theme/:id'),
      adminPage('admin.tickets', 'Tickets', 'tickets'),
      adminPage('admin.tickets.new', 'Ticket · Create', 'tickets/new'),
      adminPage('admin.tickets.stats', 'Tickets · Stats', 'tickets/stats'),
      adminPage('admin.tickets.schedules', 'Tickets · Schedules', 'tickets/schedules'),
      adminPage('admin.tickets.edit', 'Ticket · Edit', 'tickets/:id/edit'),
      adminPage('admin.tickets.chat', 'Ticket · Chat', 'tickets/:id/chat'),
      adminPage('admin.ticket.detail', 'Ticket · Detail', 'tickets/:id'),
      adminPage('admin.notifications', 'Notifications', 'notifications'),
      adminPage('admin.notifications.stats', 'Notifications · Stats', 'notifications/stats'),
      adminPage('admin.notifications.schedules', 'Notifications · Schedules', 'notifications/schedules'),
      adminPage('admin.notifications.broadcast', 'Notifications · Broadcast', 'notifications/broadcast'),
      adminPage('admin.notification.detail', 'Notification · Detail', 'notification/:id'),
      ...
      adminPage('admin.instance-pages.stats', 'Instance Pages · Stats', 'instance-pages/stats'),
      adminPage('admin.instance-pages.schedules', 'Instance Pages · Schedules', 'instance-pages/schedules'),
      adminPage('admin.instance-pages.edit', 'Instance Page · Edit', 'instance-pages/:id/studio'),
      adminPage('admin.instance-page.detail', 'Instance Page · Detail', 'instance-pages/:id'),
    ],
  },
];
